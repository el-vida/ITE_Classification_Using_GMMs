...
INPUT_PATH  = r'~\\Desktop\\VB_Schnittstelle\\Dataset\\Log' + str(LOG_ID) + '\\User_Performance\\log_' + str(LOG_ID) + '_valid_processed_new_with_user_groups_after_process_'
OUTPUT_PATH = r'~\\Desktop\\VB_Schnittstelle\\Dataset\\Log' + str(LOG_ID) + '\\log_' + str(LOG_ID) + '_valid_processed_new_with_participants_and_user_groups.csv'
