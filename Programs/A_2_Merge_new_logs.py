...
def Merge_datasets(OUTPUT_PATH):
    logs = {}
...
def Run_A_2(LOG_ID):
    ...
    INPUT_PATH  = r'C:\\Users\\eu_el\\Desktop\\VB_Schnittstelle\\Dataset\\Data\\Log' + str(LOG_ID) + '\\Participant_info\\log_' + str(LOG_ID) + '_valid_processed_new_with_participants_after_process_'
    OUTPUT_PATH = r'C:\\Users\\eu_el\\Desktop\\VB_Schnittstelle\\Dataset\\Data\\Log' + str(LOG_ID) + '\\log_' + str(LOG_ID) + '_valid_processed_new_with_participants.csv'
